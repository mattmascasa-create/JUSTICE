...
import { Shield, Moon, Sun, Mail, Lock, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md relative z-10 border-border">
        <CardHeader className="text-center">
          ...
          <CardDescription>Sign in to access your JUSTICE dashboard</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link to="/register" className="text-primary hover:underline" data-testid="goto-register">
              Sign up for free
            </Link>
          </p>
        </CardContent>
