...
import { Shield, Moon, Sun, Mail, Lock, User, Phone, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md relative z-10 border-border">
        <CardHeader className="text-center">
          ...
          <CardDescription>Get protected with JUSTICE today</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="phone">Phone (Optional - for SOS alerts)</Label>
              <div className="relative">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link to="/login" className="text-primary hover:underline" data-testid="goto-login">
              Sign in
            </Link>
          </p>
