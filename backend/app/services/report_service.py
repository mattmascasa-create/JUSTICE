...
def generate_highlights_report(
    ...
    if report_style == "formal":
        ...
        pdf.set_font('Helvetica', '', 9)
        disclaimer = """This report was generated by the JUSTICE Platform. The evidence highlights were identified using AI analysis and should be reviewed by qualified legal counsel.

Original recordings are stored with blockchain-verified timestamps. This report is a summary - complete evidence should be obtained for legal proceedings.
